        ...
        <form method="post" action="{{ route('password.update') }}" class="mt-6 space-y-6">
            ...
            <div>
                ...
                <x-text-input id="update_password_current_password" name="current_password" type="password"
                    class="mt-1 block w-full bg-none border-only-bottom" autocomplete="current-password" />
            ...
            <div>
                ...
                <x-text-input id="update_password_password" name="password" type="password"
                    class="mt-1 block w-full bg-none border-only-bottom" autocomplete="new-password" />
            ...
            <div class="d-flex justify-content-between align-items-center gap-4">
                <x-primary-button class="mt-3">{{ __('Enregistrer') }}</x-primary-button>
